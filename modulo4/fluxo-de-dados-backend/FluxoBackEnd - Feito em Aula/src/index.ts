...
import { playlist, Playlist, Musicas, editarMusica, prudutos } from "./data"
...
app.get("/test", (request, response) => {
    console.log("A API está funcionando :D")
    response.send("A API está funcionando :D")
})

app.get("/produtos", (request, response) => {
    response.send(prudutos)
})
